...
const handlers = {
    ...
    'fnSayWelcome': function () {
        //this.handler.state="_AUTH";
        //this.emit(':ask','Hi Welcome to Blue. Please tell authentication code to continue..', 'Please tell your authentication code.');
...
var authHandlers=Alexa.CreateStateHandler("_AUTH",{
    'MyNameIsIntent': function () {
        var authcode = this.event.request.intent.slots.name.value;
        console.log("Inside name intent");
        this.emit(':tell','You are authorized with '+authcode);
        //this.emit('fnAuthentication');
    },      
    'fnAuthentication': function () {
        console.log("inside auth function");
        //var authcode = this.event.request.intent.slots.name.value;
       // this.emit(':ask','You are authorized');
        //this.emit(':ask','You are authorized with code'+authcode+'. Please tell your name to help you..', 'Please tell me your name..');

        // if(authcode=='12345'){
        //     this.emit(':ask','You are authorized. Please tell your name to help you..', 'Please tell me your name..');
        // }else{
        //     this.emit(':ask','Wrong password. you can say again for retry or you can say STOP');
        // }
   }
});
